...
type eventRepository interface {
	...
	Create(ctx context.Context, name, description, location string, date *string, createdBy uuid.UUID) (*model.Event, error)
	GetByID(ctx context.Context, id uuid.UUID) (*model.Event, error)
	Update(ctx context.Context, id uuid.UUID, name, description, location string, date *string) (*model.Event, error)
